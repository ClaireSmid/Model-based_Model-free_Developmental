function drawTimeoutStatePractice(s,stimuli)
...
%         Screen('DrawTexture', pms.wid, pms.GoldTreasureTexture,[],cueRect); % replaced from BoostrayOnTexture
%     else % low stakes condition
%         Screen('DrawTexture', pms.wid, pms.BlueTreasureTexture,[],cueRect); % replaced from BoostrayOffTexture
%     end
