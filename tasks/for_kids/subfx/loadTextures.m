...
rocketFileNames = {'rocket_1_big.png';
    'rocket_2_big.png';
    'rocket_3_big.png';
    'rocket_4_big.png'};
...
% blue rectangle for stake in again
pms.stakeCueName = 'stakeCue.png';
[image,~,alpha] = imread(['img/',pms.stakeCueName]);
image(:,:,4) = alpha(:,:); % transparency
pms.stakeCueTexture = Screen('MakeTexture', pms.wid, image);

pms.exampleStakes = 'example_stakes.png';
[image,~,alpha] = imread(['img/',pms.exampleStakes]);
image(:,:,4) = alpha(:,:); % transparency
pms.exampleStakesTexture = Screen('MakeTexture', pms.wid, image);

pms.exampleStake5 = 'example_5x.png';
[image,~,alpha] = imread(['img/',pms.exampleStake5]);
image(:,:,4) = alpha(:,:); % transparency
pms.exampleStake5Texture = Screen('MakeTexture', pms.wid, image);

pms.exampleStake1 = 'example_1x.png';
[image,~,alpha] = imread(['img/',pms.exampleStake1]);
image(:,:,4) = alpha(:,:); % transparency
pms.exampleStake1Texture = Screen('MakeTexture', pms.wid, image);
...
pms.planetFileNames = {'earth_planet_big.png';
    'red_planet_big.png';
    'purple_planet_big.png'};
...
pms.rectFileNames = {'earth_rect_big.png';
    'red_rect_big.png';
    'purple_rect_big.png'};
...
pms.greyalien = 'grey_red_alien.png';
[image,~,alpha] = imread(['img/',pms.greyalien]);
image(:,:,4) = alpha(:,:); % transparency
pms.greyalienTexture = Screen('MakeTexture',pms.wid, image);

pms.greyrocket = 'grey_rocket.png';
[image,~,alpha] = imread(['img/',pms.greyrocket]);
image(:,:,4) = alpha(:,:); % transparency
pms.greyrocketTexture = Screen('MakeTexture',pms.wid, image);
