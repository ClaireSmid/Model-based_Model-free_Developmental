...
%% planet
% skip over planet, just show the alien
% stimuli = 1;
% selected = 0;
% 
...
%     drawThings(points,points,text,s2,stake,jitter); % draw the stake? % changed to drawThings rather than drawThings2
end
